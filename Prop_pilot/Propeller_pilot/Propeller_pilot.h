/** @file
 *	@brief MAVLink comm protocol generated from Propeller_pilot.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_PROPELLER_PILOT_H
#define MAVLINK_PROPELLER_PILOT_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_PROPELLER_PILOT.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
#include "./mavlink_msg_compact_state.h"
#include "./mavlink_msg_hil_propeller_state_quaternion.h"
#include "./mavlink_msg_hil_propeller_sensor.h"

#ifdef __cplusplus
}
#endif // __cplusplus
#endif // MAVLINK_PROPELLER_PILOT_H
